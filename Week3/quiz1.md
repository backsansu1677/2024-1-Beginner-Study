...
- 답: 1. 두 브랜치를 공통 부모로 하는 새로운 commit을 만듦 2. 하나의 커밋으로 main으로 병합 3.모두 새로운 커밋으로 변경
...
- 답: 지금 a1s2d3f가 가장 최근 커밋이고 develop라는 브랜치에 위치해 있다.
...
- 답: revert를 사용한다. commit를 공유하는 다른 브랜치에도 영향을 줄 수 있기 때문이다.
